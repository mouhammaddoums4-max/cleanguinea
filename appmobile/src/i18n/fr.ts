...
export const fr = {
  ...
  support: {
    titre: 'Messagerie',
    sousTitre: 'Vos échanges avec le service client',
    nouveau: 'Nouvelle demande',
    aucune: 'Aucune demande',
    aucuneDetail: "Écrivez-nous dès que quelque chose ne va pas : bac cassé, passage manqué, facture douteuse.",
    motifQuestion: 'De quoi s’agit-il ?',
    votreMessage: 'Votre message',
    messagePlaceholder: 'Décrivez ce qui s’est passé…',
    joindrePhoto: 'Joindre une photo',
    photo: 'Photo',
    photoChoix: 'Prendre une photo ou en choisir une',
    appareilPhoto: 'Appareil photo',
    galerie: 'Galerie',
    retirerPhoto: 'Retirer la photo',
    envoiPhoto: 'Envoi de la photo…',
    envoyer: 'Envoyer',
    repondre: 'Écrire un message…',
    serviceClient: 'Service client',
    filResolu: 'Cette demande est résolue. Répondez pour la rouvrir.',
    delaiReponse: 'Le service client répond sous 24 h ouvrées.',
    echecEnvoi: 'Envoi impossible',
    motif: {
      INCIDENT_COLLECTE: 'Passage manqué',
      BAC: 'Problème de bac',
