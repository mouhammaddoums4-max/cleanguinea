...
export const en: Traductions = {
  ...
  support: {
    titre: 'Messages',
    sousTitre: 'Your conversations with customer service',
    nouveau: 'New request',
    aucune: 'No request yet',
    aucuneDetail: 'Write to us whenever something goes wrong: a broken bin, a missed pickup, a bill that looks off.',
    motifQuestion: 'What is it about?',
    votreMessage: 'Your message',
    messagePlaceholder: 'Tell us what happened…',
    joindrePhoto: 'Attach a photo',
    photo: 'Photo',
    photoChoix: 'Take a photo or pick one',
    appareilPhoto: 'Camera',
    galerie: 'Gallery',
    retirerPhoto: 'Remove photo',
    envoiPhoto: 'Uploading photo…',
    envoyer: 'Send',
    repondre: 'Write a message…',
    serviceClient: 'Customer service',
    filResolu: 'This request is resolved. Reply to reopen it.',
    delaiReponse: 'Customer service replies within 24 working hours.',
    echecEnvoi: 'Could not send',
    motif: {
      INCIDENT_COLLECTE: 'Missed pickup',
      BAC: 'Bin problem',
      FACTURATION: 'Billing',
