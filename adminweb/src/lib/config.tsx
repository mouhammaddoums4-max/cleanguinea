...
const TEXTES = {
  fr: {
    ...
    annuaire: 'Annuaire', synthese: 'Synthèse', support: 'Support',
    supportSousTitre: 'Messages des clients, par ordre d’attente.',
    aTraiter: 'à traiter', repondre: 'Répondre…', envoyer: 'Envoyer',
    marquerResolu: 'Marquer résolu', rouvrir: 'Rouvrir',
    aucuneConversation: 'Aucun message',
    aucuneConversationDetail: 'Les demandes envoyées depuis l’application apparaîtront ici.',
    choisirConversation: 'Choisissez une demande pour la lire et y répondre.',
    rechercherMessage: 'Référence, client, sujet…',
    tousMotifs: 'Tous les motifs', clientDepuis: 'Client',
    ...
    tousTypes: 'Particuliers et entreprises', typeClient: 'Type',
  ...
  en: {
    ...
    annuaire: 'Directory', synthese: 'Overview', support: 'Support',
    supportSousTitre: 'Customer messages, longest waiting first.',
    aTraiter: 'to handle', repondre: 'Reply…', envoyer: 'Send',
    marquerResolu: 'Mark resolved', rouvrir: 'Reopen',
    aucuneConversation: 'No messages',
    aucuneConversationDetail: 'Requests sent from the app will show up here.',
    choisirConversation: 'Pick a request to read it and reply.',
    rechercherMessage: 'Reference, customer, subject…',
    tousMotifs: 'All topics', clientDepuis: 'Customer',
    ...
    tousTypes: 'Individuals and businesses', typeClient: 'Type',
...
const STATUTS: Record<Langue, Record<string, string>> = {
  fr: {
    ...
    OUVERTE: 'En attente', REPONDUE: 'Répondu', RESOLUE: 'Résolu',
    INCIDENT_COLLECTE: 'Passage manqué', BAC: 'Problème de bac',
    FACTURATION: 'Facturation', ABONNEMENT: 'Abonnement',
  ...
  en: {
    ...
    PARTICULIER: 'Individual', ENTREPRISE: 'Business',
    OUVERTE: 'Awaiting reply', REPONDUE: 'Answered', RESOLUE: 'Resolved',
    INCIDENT_COLLECTE: 'Missed pickup', BAC: 'Bin problem',
    FACTURATION: 'Billing', ABONNEMENT: 'Subscription',
    RECLAMATION: 'Complaint', AUTRE: 'Other',
